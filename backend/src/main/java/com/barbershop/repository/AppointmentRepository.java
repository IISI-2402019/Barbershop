...
public interface AppointmentRepository extends JpaRepository<Appointment, Long> {
    ...
    List<Appointment> findByStylistIdAndStartTimeBetweenOrderByStartTime(Long stylistId, LocalDateTime start,
            LocalDateTime end);

    // Find latest appointment for a customer (using LIMIT 1 logic)
    Appointment findFirstByCustomerIdOrderByStartTimeDesc(Long customerId);
