    ...
    CommandLineRunner initDatabase(StylistRepository stylistRepository, 
        ...
        return args -> {
            ...
            if (serviceRepository.count() == 0) {
                serviceRepository.save(new Service("Cut + Wash", 1.0, new BigDecimal("500"), false));
                serviceRepository.save(new Service("Scalp Treatment", 1.5, new BigDecimal("1200"), false));
                serviceRepository.save(new Service("Hair Dye", 2.0, new BigDecimal("2000"), true));
                serviceRepository.save(new Service("Perm", 3.0, new BigDecimal("3000"), true));
